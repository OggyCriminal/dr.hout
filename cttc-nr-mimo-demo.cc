...
main(int argc, char* argv[])
{
    ...
    // reach 200 mb/s
    Time packetInterval = NanoSeconds(6667);
    ...
    double centralFrequency = 38000e6;
    double bandwidth = 200e6;
    double gnbTxPower = 38; // dBm
    double ueTxPower = 26;  // dBm
    ...
    positionAllocUe->Add(Vector(0.0, 0.0, 15.0));
